...
describe("convertMustaches", () => {
    ...
    it("should convert nested if statements", () => {
        ...
        const result = convertMustaches(text);
        expect(result).to.equal(
            '<hbs:block:if _0="condition"><hbs:block:if _0="nested">true</hbs:block:if></hbs:block:if>',
        );
    });
    ...
    it("should convert two non nested blocks", () => {
        ...
        const result = convertMustaches(text);
        expect(result).to.equal(
            '<hbs:block:if _0="condition">true</hbs:block:if><hbs:block:if _0="nested">true</hbs:block:if>',
        );
    });
    ...
    it("should convert if-else statements", () => {
        ...
        const result = convertMustaches(text);
        expect(result).to.equal(
            '<hbs:block:if _0="condition">true<hbs:else>false</hbs:else></hbs:block:if>',
        );
    });
    ...
    it("should convert a simple if statement", () => {
        ...
        const result = convertMustaches(text);
        expect(result).to.equal(
            '<hbs:block:if _0="condition">true</hbs:block:if>',
        );
    });
    ...
    it("should convert partials", () => {
        ...
        const result = convertMustaches(text);
        expect(result).to.equal(
            '<hbs:partial _0="partialName" __param="value" />',
        );
    });
    ...
    it("should convert short comments", () => {
        ...
        const result = convertMustaches(text);
        expect(result).to.equal(
            "<hbs:comment>This is a short comment</hbs:comment>",
        );
    });
    ...
    it("should convert mustaches", () => {
        ...
        const result = convertMustaches(text);
        expect(result).to.equal(
            '<hbs:mustache _0="mustache" __param="value" />',
        );
    });
